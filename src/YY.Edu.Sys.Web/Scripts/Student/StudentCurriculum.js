    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $.each(dataCu, function (i, c) {
                ...
                str += "<a href='CurriculumDetail/?pkid=" + c.PKID + "&sid=" + $("#hdStudentID").val() + "&cid=" + c.CurriculumID + "'> ";
                ...
                str += ' <p>教练：<span>1人</span> 状态: <span>' + strState + '</span></p></div>';
                ...
                //str += " <button type='button' class='am-u-sm-2 am-u-md-2 am-u-lg-2 ClassD am-btn am-btn-success am-btn-xl am-round' onclick='CurriculumDetail(" + c.PKID + "," + $("#hdStudentID").val() + "," + c.CurriculumID + ")' class='order-btn'>详细</button>";
                //str += ' </div>';
...
$(document).ready(function () {
    ...
    //var pullContainer = 'pull_icon';
    //var moreContainer = 'more';
    //var scrollerContainer = 'scroller';
    //var callBackFunction = LoadMyCurriculum();
