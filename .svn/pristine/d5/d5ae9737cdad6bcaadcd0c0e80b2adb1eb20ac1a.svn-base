    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $.each(dataCu, function (i, c) {
                ...
                str += '  <p class="cx"><i class="iconfont">&#xe612;</i>学员:' + c.Sucount + ' 状态:<span><font  style="color:red">' + strState + '</font></span></p>';
                str += '  </a>';
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $.each(dataCu, function (i, c) {
                ...
                str += '  <p class="address"><i class="iconfont">&#xe600;</i>' + c.VenueName + "-" + c.CampusName + '</p>';
                str += '  <p class="cx"><i class="iconfont">&#xe615;</i>' + c.Title + '</p>';
                str += '  <p class="cx"><i class="iconfont">&#xe612;</i>学员:' + c.StudentFullName + '</p>';
                str += '  </a>';
