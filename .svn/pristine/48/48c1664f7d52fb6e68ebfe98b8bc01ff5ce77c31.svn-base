...
namespace YY.Edu.Sys.Web.Controllers
{
    ...
    public class OAuth2Controller : Controller
    {
        ...
        {
            var state = "junfuhao-" + DateTime.Now.Millisecond;//随机数，用于识别请求可靠性
            ...
            ViewData["UrlUserInfo"] =
                ...
                domain + "/oauth2/UserInfoCallback?returnUrl=" + returnUrl.UrlEncode(),
                state, OAuthScope.snsapi_userinfo);
            ViewData["UrlBase"] =
                OAuthApi.GetAuthorizeUrl(appId,
                domain + "/oauth2/BaseCallback?returnUrl=" + returnUrl.UrlEncode(),
