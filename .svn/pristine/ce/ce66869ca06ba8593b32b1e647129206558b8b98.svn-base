...
namespace YY.Edu.Sys.Web.Controllers
{
    public class TenPayV3Controller : Controller
    {
        ...
        public ActionResult Index(int productId = 0, int hc = 0)
        {
            ...
            string domain = "http://" + System.Configuration.ConfigurationManager.AppSettings["Domain"];

            var returnUrl = string.Format(domain + "/TenPayV3/JsApi");
        ...
        //需要OAuth登录
        [PayOAuth(null, "/TenpayV3/OAuthCallback")]
