...
namespace YY.Edu.Sys.Manage.Extensions
{
    public static class ClaimsExtensions
    {
        static string GetUserEmail(this ClaimsIdentity identity)
        {
            return identity.Claims?.FirstOrDefault(c => c.Type == "YY.Edu.Sys.Manage.Models.RegisterViewModel.Email")?.Value;
        }
        ...
        {
            return identity.Claims?.FirstOrDefault(c => c.Type == "YY.Edu.Sys.Manage.Models.RegisterViewModel.NameIdentifier")?.Value;
        }
